...
menu = ["Cohort Analysis","Recency-Frequency-Monetary Value analysis", "Clustering analysis" ]
choice = st.sidebar.selectbox('Menu',menu)

    
if choice == "Cohort Analysis":
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>1. Bảng cohort counts</h2>", unsafe_allow_html=True)
    cohort_counts
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>2. Bảng retention</h2>", unsafe_allow_html=True)
    retention
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>3. Bảng average quantity</h2>", unsafe_allow_html=True)
    average_quantity
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>4. Bảng average revenue</h2>", unsafe_allow_html=True)
    average_revenue
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>5. cohort_counts rates</h2>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>1. Bảng RFM theo customerID</h2>", unsafe_allow_html=True)
    data
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>2. Bảng RFM theo RFM_Level</h2>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>3. Báo cáo RFM</h2>", unsafe_allow_html=True)
    ...
    st.markdown("<h2 style='text-align: left; color: Yellow;'>1. K-MEAN</h2>", unsafe_allow_html=True)
